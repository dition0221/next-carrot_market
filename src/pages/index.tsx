export default function Home() {
  return (
    <main className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <section className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-1/2 block mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </section>

      <section className="bg-white overflow-hidden rounded-3xl shadow-xl group">
      ...
      <form className="flex flex-col space-y-2 p-5 rounded-3xl shadow-xl bg-blue-500 focus-within:bg-blue-100 transition">
        <input
          type="text"
          required
      ...
      <form className="flex flex-col space-y-2 p-5 rounded-3xl shadow-xl bg-white">
        <input
          type="text"
          required
          placeholder="Username"
          className="p-1 border border-gray-400 rounded peer"
        />
      ...
      <section className="bg-white p-6 rounded-3xl shadow-xl">
        <input
          type="file"
          className="file:cursor-pointer file:hover:text-purple-400 file:hover:bg-white file:hover:border-purple-400 file:hover:border file:transition-colors file:border file:border-white file:px-5 file:text-white file:rounded-xl file:bg-purple-400"
        />
        <p className="first-letter:text-5xl first-letter:hover:text-purple-400 transition-color">
          Hello
        </p>
      </section>
    </main>
